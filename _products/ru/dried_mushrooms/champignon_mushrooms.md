...
lang: "ru"
meta_description: "Грибы шампиньоны сушеные занимают особое место на потребительской полке и используются как полноценная замена свежим грибам."
categorie: dried_mushrooms

title_text: "Грибы шампиньоны сушеные занимают особое место на потребительской полке и используются как полноценная замена свежим грибам."
